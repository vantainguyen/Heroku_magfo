...
def enter_parameters():
	return render_template('mag_in.html', figure_geo = filename, arrow_J_1 = minus_arrow, arrow_J = plus_arrow, 
...
def result():
	...
	return render_template('mag_in.html', predicted_force = mag_force, figure_geo = filename, 
